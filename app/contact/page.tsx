                ...
                <div className="w-full max-w-5xl mx-auto py-10">
                    ...
                    <div className="bg-whiterelative overflow-hidden">
                        <div className="grid grid-cols-1 sm:grid-cols-6 items-center divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
                            ...
                            <div className="p-8 md:p-12 space-y-6 text-center sm:col-span-3">
                            ...
                            <div className="p-8 md:p-12 bg-slate-50/50 sm:col-span-3 h-full flex flex-col justify-top items-center text-center">
                                    ...
                                    {/* <div className="flex flex-wrap justify-center gap-3">
                                        {links.map((linkData) => (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="p-3 bg-slate-900 text-white rounded-xl hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all duration-300 shadow-sm border border-slate-100"
                                                title={linkData.name}
                                            >
