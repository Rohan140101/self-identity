...
const Hero = function () {
    return (
        ...
        <section className="min-h-[40vh] w-full bg-black flex items-center justify-center px-[5vw] py-12">
            <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-400 gap-8">
                <div className="hidden md:block w-[30vw] max-w-125 transition-transform duration-500 hover:scale-105">
                ...
                <div className="w-[80vw] md:w-[30vw] max-w-125 transition-transform duration-500 hover:scale-105">
