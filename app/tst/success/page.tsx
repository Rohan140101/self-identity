...
export default function SuccessPage() {
  ...
  <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50/50 px-6">
    <Reveal delay={0.2}>
      ...
      <div 
        className="absolute top-0 left-0 h-1.5 bg-slate-900 transition-all duration-1000 ease-linear"
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-600 text-lg leading-relaxed italic">
           We appreciate you participating in our Twenty Statements Test. 
